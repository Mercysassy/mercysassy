            ...
            @endif
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="title" name="title" @error('title') is-invalid @enderror class="form-control" id="exampleInputEmail1" placeholder="Enter title">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="author" @error('author') is-invalid @enderror class="form-control" id="exampleInputEmail1" placeholder="Enter author">
                  </div>
                  @error('Author')
                  <span class="text-danger">{{$message}}</span>
                  @enderror
